...
public class Wall implements GamePiece {
     ...
     * it is placed at the given coordinates and at (x+1, y) preventing movement
     * from (x,y) to (x, y+1) and from (x+1, y) to (x+1, y+1). 
     * If it is a vertical wall it is placed at the given coordinate 
     * and at (x, y+1) preventing movement from (x,y) to (x+1, y) and 
     * from (x, y+1) to (x+1, y+1)
     * 
